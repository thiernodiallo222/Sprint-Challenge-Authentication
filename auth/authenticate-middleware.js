...
function restrict(role = "normal") {
	return async (req, res, next) => {
		...
		try {
            ...
            // this checks to make sure the token's signature 
            // is valid.if it is, we can trust the data in the
			// payload and consider the user logged in.
            // if it isn't, we know the payload may have been 
